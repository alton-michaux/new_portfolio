    ...
    <>
      ...
      <div class={globalStyles.mainPage}>
        <div class={globalStyles.mainPageGreetBox}>
          ...
          <p class={[globalStyles.greet, globalStyles.text].join(' ')}><a class="list-group-item-action" href="https://labs.codethedream.org/portfolios/alton-michaux" target="blank">Backend Developer</a> on the <a class="list-group-item-action" href="https://sites.google.com/view/vamosprojectwiki/home" target="none">Vamos app</a></p>
